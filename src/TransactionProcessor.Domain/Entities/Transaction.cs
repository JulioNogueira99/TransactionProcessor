...
public class Transaction
{
    ...
    public byte Leg { get; private set; } 
    ...
    public Transaction(Guid accountId, TransactionType type, decimal amount, string currency, string referenceId, byte leg = 0, Guid? counterpartyAccountId = null)
    {
    ...
    public void MarkAsSuccess() { Status = TransactionStatus.Success; ErrorMessage = null; }
    public void MarkAsFailed(string error) { Status = TransactionStatus.Failed; ErrorMessage = error; }
}
